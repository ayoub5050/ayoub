...
echo $i" |"$pu" Contack nomiro :"$ku" 21047187"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" ayoubboukadida50@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy"  اختراق الفيسبوك بالايدي        "$i"|"$i"    |"$cy" A"$i" |"
echo $i"|"$me" 2"$i" |"$cy" اختراق الفيس عبر الهاتف والايمايل    "$i"|"$i"    |"$cy" Y"$i" |"
echo $i"|"$me" 3"$i" |"$cy" اختراق عبر github     "$i"|"$i"    |"$cy" o"$i" |"
echo $i"|"$me" 4"$i" |"$cy" اختراق عبر النحلة         "$i"|"$i"    |"$cy" u"$i" |"
echo $i"|"$me" 5"$i" |"$cy" لايشتغل       "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 6"$i" |"$cy" اختراق عبر ( root )   "$i"|"$i"    |"$cy" ♡"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" L"$i" |"
...
sleep 2
echo $ku"nmiro :"$i" 21047187"
echo $ku"Facebook :"$i" ayoub boukadida"
sleep 2
